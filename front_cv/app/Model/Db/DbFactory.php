...
class DbFactory
{
    ...
    public static function start() {
        ...
        ORM::configure('id_column_overrides', array(
           'competences'            =>  'id_competences',
            'experiences'           =>  'id_experiences',
            'formations'            =>  'id_formations',
            'intertitres'           =>  'id_intertitres',
            'loisirs'               =>  'id_loisirs',
            'realisations'          =>  'id_realisations',
            'titres_cv'             =>  'id_titres_cv',
